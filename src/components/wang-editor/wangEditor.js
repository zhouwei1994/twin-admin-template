...
*/
  ...
  Code.prototype = {
            ...
            events: [
              // 插入代码
              {
                ...
                fn: function fn() {
                  ...
                  if (_this.editor.customConfig.codeHandle) {
                    text = _this.editor.customConfig.codeHandle(text);
                  }
                  if (type === "new") {
                    // 新插入
    ...
    _insertCode: function _insertCode(value) {
      ...
      editor.cmd.do(
        "insertHTML",
        "<pre class='prettyprint linenums:1' style='padding-left: 15px'>" +
        value +
        "</pre><p><br></p>"
      );
      setTimeout(function () {
  ...
  */
  function FullScreen(editor) {
    this.editor = editor;
    this.$elem = $(
      '<div class="w-e-menu full-screen">\n            全屏\n        </div>'
    );
    this.type = "panel";
  ...
  FullScreen.prototype = {
    ...
    onClick: function onClick() {
      console.log("全屏");
      let wangEditorobj = document.querySelector(".wang-editor");
      if (wangEditorobj.classList.contains("wang-editor-full-screen")) {
        document.querySelector(".full-screen").innerHTML = "全屏";
        wangEditorobj.classList.remove("wang-editor-full-screen");
      } else {
        document.querySelector(".full-screen").innerHTML = "取消全屏";
        wangEditorobj.classList.add("wang-editor-full-screen");
      }
    },
  };
  /*
...
*/
  ...
  Video.prototype = {
    ...
    _createPanel: function _createPanel() {
      ...
      var btnId = getRandom("btn");
      var uploadVideo = _this.editor.uploadVideo;
      // id
...
*/
  ...
  Image.prototype = {
    ...
    _createInsertPanel: function _createInsertPanel() {
      var editor = this.editor;
      if (editor.customConfig.imageClick) {
        editor.customConfig.imageClick();
      } else {
        ...
        if (config.customUploadImg && window.FileReader) {
          // 显示“上传图片”
    ...
    uploadImg: function uploadImg(files) {
      ...
      if (customUploadImg && typeof customUploadImg === "function") {
        customUploadImg({
          files: resultFiles,
          success: (res) => {
            this.insertLinkImg(res);
          },
          progress: (res) => {
            editor.progress.show(res);
          },
          complete: (res) => {
  ...
  Editor.prototype = {
    ...
    _initDom: function _initDom() {
      ...
      if (textSelector == null) {
        ...
        console.log("----------1", $toolbarSelector, $toolbarElem);
        // 添加到 DOM 结构中
        $toolbarSelector.append($toolbarElem).append($textContainerElem);
        console.log("----------2", $toolbarSelector);
        // 自行创建的，需要配置默认的样式
        $toolbarElem
